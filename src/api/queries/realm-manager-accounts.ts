...
import type {
  ...
  RealmManagerAccountsSchedulePartialUpdateErrorResponse400,
  RealmManagerAccountsScheduleRetrieveErrorResponse400,
  RealmManagerAccountsScheduleUpdateErrorResponse400,
...
export function useRealmManagerAccountsList<TData = Awaited<ReturnType<typeof realmManagerAccountsList>>, TError = ErrorType<RealmManagerAccountsListErrorResponse400>>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof realmManagerAccountsList>>, TError, TData>> & Pick<
  DefinedInitialDataOptions<
  Awaited<ReturnType<typeof realmManagerAccountsList>>,
  TError,
  TData
  >, 'initialData'
...
export function useRealmManagerAccountsRetrieve<TData = Awaited<ReturnType<typeof realmManagerAccountsRetrieve>>, TError = ErrorType<RealmManagerAccountsRetrieveErrorResponse400>>(
  id: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof realmManagerAccountsRetrieve>>, TError, TData>> & Pick<
  DefinedInitialDataOptions<
  Awaited<ReturnType<typeof realmManagerAccountsRetrieve>>,
  TError,
  TData
  >, 'initialData'
  >, request?: SecondParameter<typeof queryInstance> }
...
export function useRealmManagerAccountsRetrieve<TData = Awaited<ReturnType<typeof realmManagerAccountsRetrieve>>, TError = ErrorType<RealmManagerAccountsRetrieveErrorResponse400>>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof realmManagerAccountsRetrieve>>, TError, TData>>, request?: SecondParameter<typeof queryInstance> }): UseQueryResult<TData, TError> & { queryKey: QueryKey } {
...
/**
 * Endpoint to retrieve a Player's own schedule.

If a schedule doesn't exist, this will create a default (empty) one.
 * @summary Retrieve player schedule
 */
export const realmManagerAccountsScheduleRetrieve = (
  id: string,
  options?: SecondParameter<typeof queryInstance>,
  signal?: AbortSignal,
) => queryInstance<Schedule>(
  { url: `/realm-manager/accounts/${id}/schedule/`, method: 'GET', signal },
  options,
);

export const getRealmManagerAccountsScheduleRetrieveQueryKey = (id: string) => [`/realm-manager/accounts/${id}/schedule/`] as const;

export const getRealmManagerAccountsScheduleRetrieveQueryOptions = <TData = Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>, TError = ErrorType<RealmManagerAccountsScheduleRetrieveErrorResponse400>>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>, TError, TData>>, request?: SecondParameter<typeof queryInstance> },
) => {
  const { query: queryOptions, request: requestOptions } = options ?? {};

  const queryKey = queryOptions?.queryKey ?? getRealmManagerAccountsScheduleRetrieveQueryKey(id);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>> = ({ signal }) => realmManagerAccountsScheduleRetrieve(id, requestOptions, signal);

  return { queryKey, queryFn, enabled: !!(id), ...queryOptions } as UseQueryOptions<Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>, TError, TData> & { queryKey: QueryKey };
};

export type RealmManagerAccountsScheduleRetrieveQueryResult = NonNullable<Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>>;
export type RealmManagerAccountsScheduleRetrieveQueryError = ErrorType<RealmManagerAccountsScheduleRetrieveErrorResponse400>;

export function useRealmManagerAccountsScheduleRetrieve<TData = Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>, TError = ErrorType<RealmManagerAccountsScheduleRetrieveErrorResponse400>>(
  id: string, options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>, TError, TData>> & Pick<
  DefinedInitialDataOptions<
  Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>,
  TError,
  TData
  >, 'initialData'
  >, request?: SecondParameter<typeof queryInstance> }
...
export function useRealmManagerAccountsScheduleRetrieve<TData = Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>, TError = ErrorType<RealmManagerAccountsScheduleRetrieveErrorResponse400>>(
  id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>, TError, TData>>, request?: SecondParameter<typeof queryInstance> }
...
export function useRealmManagerAccountsScheduleRetrieve<TData = Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>, TError = ErrorType<RealmManagerAccountsScheduleRetrieveErrorResponse400>>(id: string, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof realmManagerAccountsScheduleRetrieve>>, TError, TData>>, request?: SecondParameter<typeof queryInstance> }): UseQueryResult<TData, TError> & { queryKey: QueryKey } {
  const queryOptions = getRealmManagerAccountsScheduleRetrieveQueryOptions(id, options);
...
/**
 * Endpoint to update a Player's own schedule.

If a schedule doesn't exist, this will create a default (empty) one.
 * @summary Update player schedule
 */
export const realmManagerAccountsScheduleUpdate = (
  id: string,
  scheduleRequest: BodyType<ScheduleRequest>,
  options?: SecondParameter<typeof queryInstance>,
) => queryInstance<Schedule>(
  { url: `/realm-manager/accounts/${id}/schedule/`,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json' },
...
export const getRealmManagerAccountsScheduleUpdateMutationOptions = <TError = ErrorType<RealmManagerAccountsScheduleUpdateErrorResponse400>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof realmManagerAccountsScheduleUpdate>>, TError, { id: string;data: BodyType<ScheduleRequest> }, TContext>, request?: SecondParameter<typeof queryInstance> },
  ): UseMutationOptions<Awaited<ReturnType<typeof realmManagerAccountsScheduleUpdate>>, TError, { id: string;data: BodyType<ScheduleRequest> }, TContext> => {
  const { mutation: mutationOptions, request: requestOptions } = options ?? {};

  const mutationFn: MutationFunction<Awaited<ReturnType<typeof realmManagerAccountsScheduleUpdate>>, { id: string;data: BodyType<ScheduleRequest> }> = (props) => {
    const { id, data } = props ?? {};

    return realmManagerAccountsScheduleUpdate(id, data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type RealmManagerAccountsScheduleUpdateMutationResult = NonNullable<Awaited<ReturnType<typeof realmManagerAccountsScheduleUpdate>>>;
export type RealmManagerAccountsScheduleUpdateMutationBody = BodyType<ScheduleRequest>;
export type RealmManagerAccountsScheduleUpdateMutationError = ErrorType<RealmManagerAccountsScheduleUpdateErrorResponse400>;

/**
 * @summary Update player schedule
 */
export const useRealmManagerAccountsScheduleUpdate = <TError = ErrorType<RealmManagerAccountsScheduleUpdateErrorResponse400>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof realmManagerAccountsScheduleUpdate>>, TError, { id: string;data: BodyType<ScheduleRequest> }, TContext>, request?: SecondParameter<typeof queryInstance> },
  ): UseMutationResult<
  Awaited<ReturnType<typeof realmManagerAccountsScheduleUpdate>>,
  TError,
  { id: string;data: BodyType<ScheduleRequest> },
  TContext
  > => {
  const mutationOptions = getRealmManagerAccountsScheduleUpdateMutationOptions(options);

  return useMutation(mutationOptions);
};
/**
 * Endpoint to partially update a Player's own schedule.

If a schedule doesn't exist, this will create a default (empty) one.
 * @summary Partially update player schedule
 */
export const realmManagerAccountsSchedulePartialUpdate = (
  id: string,
  patchedScheduleRequest: BodyType<PatchedScheduleRequest>,
  options?: SecondParameter<typeof queryInstance>,
) => queryInstance<Schedule>(
  { url: `/realm-manager/accounts/${id}/schedule/`,
    method: 'PATCH',
...
export const getRealmManagerAccountsSchedulePartialUpdateMutationOptions = <TError = ErrorType<RealmManagerAccountsSchedulePartialUpdateErrorResponse400>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof realmManagerAccountsSchedulePartialUpdate>>, TError, { id: string;data: BodyType<PatchedScheduleRequest> }, TContext>, request?: SecondParameter<typeof queryInstance> },
  ): UseMutationOptions<Awaited<ReturnType<typeof realmManagerAccountsSchedulePartialUpdate>>, TError, { id: string;data: BodyType<PatchedScheduleRequest> }, TContext> => {
  const { mutation: mutationOptions, request: requestOptions } = options ?? {};

  const mutationFn: MutationFunction<Awaited<ReturnType<typeof realmManagerAccountsSchedulePartialUpdate>>, { id: string;data: BodyType<PatchedScheduleRequest> }> = (props) => {
    const { id, data } = props ?? {};

    return realmManagerAccountsSchedulePartialUpdate(id, data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type RealmManagerAccountsSchedulePartialUpdateMutationResult = NonNullable<Awaited<ReturnType<typeof realmManagerAccountsSchedulePartialUpdate>>>;
export type RealmManagerAccountsSchedulePartialUpdateMutationBody = BodyType<PatchedScheduleRequest>;
export type RealmManagerAccountsSchedulePartialUpdateMutationError = ErrorType<RealmManagerAccountsSchedulePartialUpdateErrorResponse400>;

/**
 * @summary Partially update player schedule
 */
export const useRealmManagerAccountsSchedulePartialUpdate = <TError = ErrorType<RealmManagerAccountsSchedulePartialUpdateErrorResponse400>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof realmManagerAccountsSchedulePartialUpdate>>, TError, { id: string;data: BodyType<PatchedScheduleRequest> }, TContext>, request?: SecondParameter<typeof queryInstance> },
  ): UseMutationResult<
  Awaited<ReturnType<typeof realmManagerAccountsSchedulePartialUpdate>>,
  TError,
  { id: string;data: BodyType<PatchedScheduleRequest> },
  TContext
  > => {
  const mutationOptions = getRealmManagerAccountsSchedulePartialUpdateMutationOptions(options);
