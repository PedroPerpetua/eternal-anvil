...
export function useUsersProfileRetrieve<TData = Awaited<ReturnType<typeof usersProfileRetrieve>>, TError = ErrorType<UsersProfileRetrieveErrorResponse400>>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof usersProfileRetrieve>>, TError, TData>> & Pick<
  DefinedInitialDataOptions<
  Awaited<ReturnType<typeof usersProfileRetrieve>>,
  TError,
  TData
  >, 'initialData'
...
export function useUsersWhoami<TData = Awaited<ReturnType<typeof usersWhoami>>, TError = ErrorType<UsersWhoamiErrorResponse400>>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof usersWhoami>>, TError, TData>> & Pick<
  DefinedInitialDataOptions<
  Awaited<ReturnType<typeof usersWhoami>>,
  TError,
  TData
  >, 'initialData'
  >, request?: SecondParameter<typeof queryInstance> }
